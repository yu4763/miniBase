...
public class JoinOptimizer {
     ...
     * algorithms) that you implemented for Lab. It should be a function of
    ...
    public double estimateJoinCost(LogicalJoinNode j, int card1, int card2,
        ...
        if (j instanceof LogicalSubplanJoinNode) {
            ...
            // You do not need to implement proper support for this .
    ...
    public Vector<LogicalJoinNode> orderJoins(
        ...
        // some code goes here
         ...
         Set<LogicalJoinNode> joinsets = new HashSet<LogicalJoinNode>(joins);
         
         int len = joinsets.size();
         for (int i=1; i<=len; i++){
         ...
         Vector<LogicalJoinNode> best = cache.getOrder(joinsets);
